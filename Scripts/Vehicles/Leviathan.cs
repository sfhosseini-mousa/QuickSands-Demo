...

{
    ...
    {
        public Leviathan(string name, int id, int maxHP, int currentHP, int speed, int buttspace, int capacity, int price) : base(name, id, maxHP, currentHP, speed, buttspace, capacity, price) { }
